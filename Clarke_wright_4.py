...
# Load the dataset
data = pd.read_excel("Route_Data_Small.xlsx", "Sheet1")
print(data)
...
with open('temp1.csv','w',newline='') as file:
    writer=csv.writer(file)
